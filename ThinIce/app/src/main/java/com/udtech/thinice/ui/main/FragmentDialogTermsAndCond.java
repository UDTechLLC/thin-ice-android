...
public class FragmentDialogTermsAndCond extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        SpannableString text = new SpannableString(Html.fromHtml( getContext().getResources().getString(R.string.terms_and_conditions)));
