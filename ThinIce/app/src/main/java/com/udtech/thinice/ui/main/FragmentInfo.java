    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (((EditText) getView().findViewById(R.id.weight)).getText().toString().isEmpty() || ((EditText) getView().findViewById(R.id.height)).getText().toString().isEmpty()) {
                    if (((EditText) getView().findViewById(R.id.weight)).getText().toString().isEmpty()) {
                        showWeightError("Empty value");
                    }
                    if (((EditText) getView().findViewById(R.id.height)).getText().toString().isEmpty()) {
        ...
        controller = new
                ...
                HeightController(view.findViewById(R.id.ft));
        ...
        ((Spinner) view.findViewById(R.id.sex)).

                setAdapter(new ArrayAdapter<String>(getActivity(), R.layout.item_spinner, R.id.tittle, Arrays.asList(new String[]
        ...
        ((Spinner) view.findViewById(R.id.year)).
                ...
                setAdapter(new ArrayAdapter<String>(getActivity(), R.layout.item_spinner, R.id.tittle, values));
        String[] months = new DateFormatSymbols().getMonths();
        ((Spinner) view.findViewById(R.id.months)).

                setAdapter(new ArrayAdapter<String>(getActivity(), R.layout.item_spinner, R.id.tittle, months));
        ...
        ((Spinner) view.findViewById(R.id.days)).
...

        {
            ...
            if (settings.isLenght()) {
                ...
                getView().findViewById(R.id.height).setVisibility(View.VISIBLE);
                (getView().findViewById(R.id.ft)).setVisibility(View.GONE);
            }
            ((EditText) getView().findViewById(R.id.height)).setText(Math.round(user.getHeight()) + "");
            String dateOfB = new SimpleDateFormat("yyyy.MM.dd").format(user.getDateOfBirth());
            dateOfB.isEmpty();
