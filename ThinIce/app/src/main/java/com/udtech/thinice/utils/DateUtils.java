...
/**
 * Created by JOkolot on 07.12.2015.
 */
...
//        return isSameWeek(cal1, cal2);
    ...
    public static boolean inTwoWeeks(Date date1, Date date2) {
        ...
        return Math.abs(date1.getTime() - date2.getTime())<1000*60*60*24*14;
//
//        Calendar cal1 = Calendar.getInstance();
//        cal1.setTime(date1);
//        Calendar cal2 = Calendar.getInstance();
...
//        return inTwoWeeks(cal1, cal2);
    ...
    public static boolean isSameMonth(Date date1, Date date2) {
        ...
        return Math.abs(date1.getTime() - date2.getTime())<1000f*60f*60f*24f*30f;
