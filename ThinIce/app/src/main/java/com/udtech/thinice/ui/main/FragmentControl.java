...
public class FragmentControl extends Fragment {
    ...
    public void onEvent(DevicePaired event){
        onEvent(new DeleteDevice(DeviceManager.getDevice()));
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.action).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getActivity().getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.fade_in, R.anim.fade_out).replace(R.id.fragment_container, new FragmentAddWear()).addToBackStack(null).commit();
            }
        });
