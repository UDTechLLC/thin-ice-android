...
public class FragmentDevices extends Fragment {
        ...
        view.findViewById(R.id.power).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (DeviceManager.getDevice() != null)
                    EventBus.getDefault().post(new SendMessage(!DeviceManager.getDevice().isDisabled() ? (new Protocol().getDisable()) : (new Protocol().getOn((int) DeviceManager.getDevice().getTemperature()))));
            }
        });
    ...
    public void onEvent(DevicePaired event) {
        check(getView());
    }
            ...
            getActivity().runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (view != null && getActivity() != null) {
                        ...
                        if (DeviceManager.getDevice() != null) {
                            view.findViewById(R.id.power).setEnabled(true);
                        ...
                        if (DeviceManager.getDevice() == null) {
                            ...
                            view.findViewById(R.id.power).setEnabled(false);
